...
* NOTE is the keyEncryption is set to http://www.w3.org/2009/xmlenc11#rsa-oaep, 
* the keyEncryptionMgfAlgorithm should also be specified for proper encryption.
...
var encryptAssertionXml = (assertionToEncrypt, options) =>
  new Promise((resolve, reject) => {
    var encryptOptions = {
      ...
      keyEncryptionDigest: options.encryptionDigestAlgorithm,
      keyEncryptionMgf: options.keyEncryptionMgfAlgorithm
    };
