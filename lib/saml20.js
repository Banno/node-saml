...
function extractSaml20Options(opts) {
  return {
    ...
    includeFriendlyName: (typeof opts.includeFriendlyName !== 'undefined') ? opts.includeFriendlyName : false,
  };
}
 ...
 * @param [options.includeFriendlyName] {boolean}
 *
 * // XML Dsig
...
function createAssertion(options, strategies, callback) {
  ...
  if (options.attributes) {
    ...
    Object.keys(options.attributes).forEach(function(prop) {
      ...
      if (options.includeFriendlyName){
